...
function FTC.Frames:Controls()
	...
	if ( FTC.vars.EnableFrames ) then
		...
		health.current		= FTC.UI.Label( "FTC_PlayerFrame_HealthCurrent" , health , { health:GetWidth() - 16 , health:GetHeight() } , {CENTER,CENTER,0,0} , "ZoFontWindowSubtitle" , nil , {LEFT,TOP} , 'Health' , false )		
		health.pct			= FTC.UI.Label( "FTC_PlayerFrame_HealthPct" , health , { health:GetWidth() - 16 , health:GetHeight() } , {CENTER,CENTER,0,0} , "ZoFontWindowSubtitle" , nil , {RIGHT,TOP} , 'Pct%' , false )
		...
		magicka.current		= FTC.UI.Label( "FTC_PlayerFrame_MagickaCurrent" , magicka , { magicka:GetWidth() - 16 , magicka:GetHeight() } , {CENTER,CENTER,0,0} , "ZoFontAnnounceSmall" , nil , {LEFT,TOP} , 'Magicka' , false )
		magicka.pct			= FTC.UI.Label( "FTC_PlayerFrame_MagickaPct" , magicka , { magicka:GetWidth() - 16 , magicka:GetHeight() } , {CENTER,CENTER,0,0} , "ZoFontAnnounceSmall" , nil , {RIGHT,TOP}, 'Pct%' , false )
		...
		stamina.current		= FTC.UI.Label( "FTC_PlayerFrame_StaminaCurrent" , stamina , { stamina:GetWidth() - 16 , stamina:GetHeight() } , {CENTER,CENTER,0,0} , "ZoFontAnnounceSmall" , nil , {LEFT,TOP} , 'Stamina' , false )		
		stamina.pct			= FTC.UI.Label( "FTC_PlayerFrame_StaminaPct" , stamina , { stamina:GetWidth() - 16 , stamina:GetHeight() } , {CENTER,CENTER,0,0} , "ZoFontAnnounceSmall" , nil , {RIGHT,TOP}, 'Pct%' , false )
		...
		-- Create the unit frame container	
		local target 		= FTC.UI.TopLevelWindow( "FTC_TargetFrame" , GuiRoot , {350,34} , {anchor[1],anchor[2],anchor[3],anchor[4]} , true )
		...
		-- Create health bar
		local thp 			= FTC.UI.Backdrop( "FTC_TargetFrame_Health" , target , {350,34} , {TOP,TOP,0,0,target} , {0.1,0,0,1} , {0,0,0,0} , false )
